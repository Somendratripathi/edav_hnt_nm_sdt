---
title: "FP_executive_summary_charts"
...
# Home Environment
```{r message=FALSE, fig1, fig.height = 4, fig.width = 10}
student_por %>%
...
# Social
```{r message=FALSE, fig2, fig.height = 6, fig.width = 10}
...
# Parents
```{r message=FALSE, fig3, fig.height = 4, fig.width = 10}
student_por %>% 
...
# Academics
```{r message=FALSE, fig4, fig.height = 4, fig.width = 10}
...
# Others
```{r message=FALSE, fig6, fig.height = 4, fig.width = 10}
